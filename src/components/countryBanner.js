...
//import '../styles/CountryBanner.module.css'; // Make sure to create and link a CSS file for styling
        ...
        <div className="country-banner" style={{
            ...
            <div className="visa-timeline" style={{
                ...
                <div className="visa-timeline-inner" style={{ display: 'flex', alignItems: 'center', width: '253px', height: '53px' }}>
                    ...
                    <div className="visa-timeline-text" style={{ display: 'flex', flexDirection: 'column', flex: 0.8, alignItems: 'start', maxWidth : isMobile ? '120px' : '' ,  display: 'block', textAlign: 'start' }}>
                        <p style={{ margin: 0, fontWeight: 'bold', marginBottom: '5px', whiteSpace: 'nowrap', fontFamily: 'Nunito Sans, sans-serif', fontSize: isMobile ? '10px' : '', overflow: 'hidden', textOverflow: 'ellipsis' }}>Get your visa by {calculateVisaDate(data.visaTimeline)},</p>
